...
public final class Constants {
     ...
     */
    public static final String[] bloodTypes = {
            "A+",
            "A-",
            "B+",
            "B-",
     ...
     */
    public static final int[] bloodTypeProbabilities = {
            31,
            7,
            10,
            2,
     ...
     */
    public static final int[] eyeColorProbabilities = {
            5,
            10,
            30,
            20,
     ...
     */
    public static final String[] EMAIL_SERVICE_PROVIDERS = {
            "gmail.com",
            "yahoo.com",
            "hotmail.com",
            "outlook.com",
     ...
     */
    public static final int[] EMAIL_SERVICE_PROVIDER_PROBABILITIES = {
            50,
            10,
            10,
            15,
     ...
     */
    public static final String[] EMAIL_NAME_FORMATS = {
            "%s.%s",
            "%s%s",
            "%s",
            "%s_%s",
     ...
     */
    public static final int[] ageDistribution = {
            32,
            30,
            23,
            12,
     ...
     */
    public static final int[][] MALE_HEIGHTS = {
            {150, 5},
            {155, 10},
            {160, 20},
            {165, 30},
     ...
     */
    public static final int[][] FEMALE_HEIGHTS = {
            {145, 5},
            {150, 10},
            {155, 20},
            {160, 30},
     ...
     */
    public static final int[][] OTHER_HEIGHTS = {
            {145, 5},
            {155, 10},
            {160, 20},
            {165, 34},
     ...
     */
    public static final int[][] MALE_WEIGHTS = {
            {50, 5},
            {55, 10},
            {60, 20},
            {65, 30},
     ...
     */
    public static final int[][] FEMALE_WEIGHTS = {
            {45, 5},
            {50, 10},
            {55, 20},
            {60, 30},
     ...
     */
    public static final int[][] OTHER_WEIGHTS = {
            {45, 5},
            {55, 10},
            {60, 20},
            {65, 34},
     ...
     */
    public static final int[] religionProbabilities = {
            31,
            24,
            15,
            6,
